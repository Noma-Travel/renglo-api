...
def load_env_config(config_path=None):
    ...
    env_var_keys = [
        ...
        'CORS_ALLOWED_ORIGINS', 'DATA_API_RING_POLICY',
        ...
        # WhatsApp (Meta Cloud API / Twilio) — public webhook + outbound
        'WHATSAPP_WEBHOOK_SECRET',
        'WA_PROVIDER', 'WA_ACCESS_TOKEN', 'WA_PHONE_NUMBER_ID', 'WA_PHONE_NUMBER',
        'WA_APP_SECRET', 'WA_VERIFY_TOKEN',
        'WA_DEFAULT_PORTFOLIO', 'WA_DEFAULT_ORG', 'WA_DEFAULT_TRIP_ID', 'WA_DEFAULT_USER_ID',
        'WA_DIRECTORY_PORTFOLIO', 'WA_DIRECTORY_ORG',
        'WA_TEMPLATE_FLIGHT_OPTIONS',
        'TWILIO_ACCOUNT_SID', 'TWILIO_AUTH_TOKEN', 'TWI_WA_NUMBER',
    ]
